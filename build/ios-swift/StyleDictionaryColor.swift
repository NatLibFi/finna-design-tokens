...
public enum StyleDictionaryColor {
    public static let bodyTextBaseColor = UIColor(red: 0.129, green: 0.145, blue: 0.161, alpha: 1)
    public static let gray100 = UIColor(red: 0.973, green: 0.976, blue: 0.980, alpha: 1)
    public static let gray200 = UIColor(red: 0.914, green: 0.925, blue: 0.937, alpha: 1)
    public static let gray300 = UIColor(red: 0.871, green: 0.886, blue: 0.902, alpha: 1)
    public static let gray400 = UIColor(red: 0.808, green: 0.831, blue: 0.855, alpha: 1)
    public static let gray500 = UIColor(red: 0.678, green: 0.710, blue: 0.741, alpha: 1)
    public static let gray600 = UIColor(red: 0.424, green: 0.459, blue: 0.490, alpha: 1)
    ...
    public static let primaryColor = UIColor(red: 0.000, green: 0.486, blue: 0.565, alpha: 1)
    public static let secondaryColor = UIColor(red: 0.424, green: 0.459, blue: 0.490, alpha: 1)
